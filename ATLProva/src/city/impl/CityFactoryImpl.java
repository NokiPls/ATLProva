...
public class CityFactoryImpl extends EFactoryImpl implements CityFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case CityPackage.CITY: return createCity();
			case CityPackage.PLACE: return createPlace();
			case CityPackage.CATEGORY: return createCategory();
			case CityPackage.DISTRICT: return createDistrict();
			case CityPackage.CITY_MODEL: return createCityModel();
			default:
