 ...
 *   <li>{@link cs.impl.MonitoredCityImpl#getCoordBx <em>Coord Bx</em>}</li>
 *   <li>{@link cs.impl.MonitoredCityImpl#getCoordBy <em>Coord By</em>}</li>
 *   <li>{@link cs.impl.MonitoredCityImpl#getCoordEx <em>Coord Ex</em>}</li>
 *   <li>{@link cs.impl.MonitoredCityImpl#getCoordEy <em>Coord Ey</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MonitoredCityImpl extends MinimalEObjectImpl.Container implements MonitoredCity {
	...
	public void setCoordBx(float newCoordBx) {
		...
		coordBx = newCoordBx;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CsPackage.MONITORED_CITY__COORD_BX, oldCoordBx, coordBx));
	}
	...
	public void setCoordBy(float newCoordBy) {
		...
		coordBy = newCoordBy;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CsPackage.MONITORED_CITY__COORD_BY, oldCoordBy, coordBy));
	}
	...
	public void setCoordEx(float newCoordEx) {
		...
		coordEx = newCoordEx;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CsPackage.MONITORED_CITY__COORD_EX, oldCoordEx, coordEx));
	}
	...
	public void setCoordEy(float newCoordEy) {
		...
		coordEy = newCoordEy;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CsPackage.MONITORED_CITY__COORD_EY, oldCoordEy, coordEy));
	}
