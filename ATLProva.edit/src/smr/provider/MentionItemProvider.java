...
/**
 * This is the item provider adapter for a {@link smr.Mention} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MentionItemProvider extends TagItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((Mention)object).getText();
		return label == null || label.length() == 0 ?
			getString("_UI_Mention_type") :
