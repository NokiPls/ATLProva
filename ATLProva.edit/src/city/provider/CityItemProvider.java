...
/**
 * This is the item provider adapter for a {@link city.City} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CityItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CityPackage.Literals.CITY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCoordBxPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_City_coordBx_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_City_coordBx_feature", "_UI_City_type"),
				 CityPackage.Literals.CITY__COORD_BX,
				 true,
				 false,
				 false,
	...
	protected void addCoordByPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_City_coordBy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_City_coordBy_feature", "_UI_City_type"),
				 CityPackage.Literals.CITY__COORD_BY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addCoordExPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_City_coordEx_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_City_coordEx_feature", "_UI_City_type"),
				 CityPackage.Literals.CITY__COORD_EX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addCoordEyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_City_coordEy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_City_coordEy_feature", "_UI_City_type"),
				 CityPackage.Literals.CITY__COORD_EY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CityPackage.Literals.CITY__DISTRICTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CityPackage.Literals.CITY__DISTRICTS,
				 CityFactory.eINSTANCE.createDistrict()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return CityEditPlugin.INSTANCE;
	}
