...
/**
 * This is the item provider adapter for a {@link city.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CategoryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_type_feature", "_UI_Category_type"),
				 CityPackage.Literals.CATEGORY__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Categories labelValue = ((Category)object).getType();
