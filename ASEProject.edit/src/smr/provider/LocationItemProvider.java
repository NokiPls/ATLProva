...
/**
 * This is the item provider adapter for a {@link smr.Location} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SmrPackage.Literals.LOCATION__CITY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SmrPackage.Literals.LOCATION__ADDRESS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDistrictPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Location_district_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Location_district_feature", "_UI_Location_type"),
				 SmrPackage.Literals.LOCATION__DISTRICT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SmrPackage.Literals.LOCATION__PLACE);
			childrenFeatures.add(SmrPackage.Literals.LOCATION__COORDINATES);
		}
	...
	public String getText(Object object) {
		String label = ((Location)object).getCity();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Location.class)) {
			case SmrPackage.LOCATION__CITY:
			case SmrPackage.LOCATION__ADDRESS:
			case SmrPackage.LOCATION__DISTRICT:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case SmrPackage.LOCATION__PLACE:
			case SmrPackage.LOCATION__COORDINATES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SmrPackage.Literals.LOCATION__PLACE,
				 SmrFactory.eINSTANCE.createPlace()));

		newChildDescriptors.add
			(createChildParameter
				(SmrPackage.Literals.LOCATION__COORDINATES,
				 SmrFactory.eINSTANCE.createCoordinates()));
	}
