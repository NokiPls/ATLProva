 ...
 * @generated
 */
public class CityValidationDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = CityDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof CityDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& CityModelEditPart.MODEL_ID.equals(CityVisualIDRegistry
						.getModelID(view));
	}
