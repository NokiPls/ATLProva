...
import city.diagram.edit.policies.CityTextSelectionEditPolicy;
 ...
 * @generated
 */
public class DistrictNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DistrictNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new CityTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return CityElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CityParserProvider
					.getParser(
							CityElementTypes.District_3001,
							getParserElement(),
							CityVisualIDRegistry
									.getType(city.diagram.edit.parts.DistrictNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					CityEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
