...
import city.diagram.edit.policies.PlaceItemSemanticEditPolicy;
...
public class PlaceEditPart extends ShapeNodeEditPart {
	...
	public class PlaceFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigurePlaceLabelFigure;
		...
		private void createContents() {
			...
			fFigurePlaceLabelFigure = new WrappingLabel();

			fFigurePlaceLabelFigure.setText("Place");

			this.add(fFigurePlaceLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigurePlaceLabelFigure() {
			return fFigurePlaceLabelFigure;
		}
